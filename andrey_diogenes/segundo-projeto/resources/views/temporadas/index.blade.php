...
@section('content')
    ...
    @endif
    <h1 class="mt-5">Lista de Temporadas</h1>
        ...
        <tbody>
            @foreach ($temporadas as $temporada)
                <tr class="align-middle">
                    ...
                    <td>
                        <a class="text-decoration-none" href="{ { route('series.show', $serie) } }">
                            {{ $temporada->numero }}
                        </a>
                    </td>
                    <td>
                    ...
                    <td><!--
                        <a class="float-start p-1" href="{ { route('series.edit', $serie) } }">
                            <button type="button" class="btn btn-warning">
                                <svg class="mb-1" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil" viewBox="0 0 16 16">
                        ...
                        <!--<form class="float-start p-1" action="{ { route('temporadas.destroy', $temporada) } }" method="POST">
                            @csrf
                            @method('DELETE')
