        ...
        <tbody>
            @foreach ($estudantes as $estudante)
                <tr class="align-middle">
                    ...
                    <td>
                        <a class="text-decoration-none" href="{{ route('estudantes.show', $estudante) }}">
                            {{ $estudante->nome }}
                        </a>
                    </td>
                    <td>{{ $estudante->cpf }}</td>
                    ...
                    <td>
                        <a class="float-start p-1" href="{{ route('estudantes.edit', $estudante) }}">
                        ...
                        <form class="float-start p-1" action="{{ route('estudantes.destroy', $estudante) }}" method="POST">
                            @csrf
                            @method('DELETE')
