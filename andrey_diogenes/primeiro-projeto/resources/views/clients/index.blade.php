        ...
        <tbody>
            @foreach ($clients as $client)
                <tr class="align-middle">
                    ...
                    <td>
                        <a class="text-decoration-none" href="{{ route('clients.show', $client) }}">
                            {{ $client->nome }}
                        </a>
                    </td>
                    ...
                    <td>
                        <a class="float-start p-1" href="{{ route('clients.edit', $client) }}">
                        ...
                        <form class="float-start p-1" action="{{ route('clients.destroy', $client) }}" method="POST">
                            @csrf
                            @method('DELETE')
