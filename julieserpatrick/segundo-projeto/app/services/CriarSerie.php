...
class CriarSerie
{
    public function save(string $nomeSerie, int $qtdTemporadas, int $epPorTemporada): SerieModel
    {
        DB::beginTransaction();
    ...
    public function criaTemporada( int $qtdTemporadas, int $epPorTemporada,SerieModel $serie): void
    {
